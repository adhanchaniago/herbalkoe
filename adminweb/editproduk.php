	...
	?>
		<h2>EDIT PRODUK</h2>
          ...
          <table border="0">
            <tr>
              <td>Nama Produk</td>
              <td><input name="nama" type="text" id="nama" value="<?php echo $r_edit[nama]; ?>" size="50" /></td>
            </tr>
            <tr>
              <td>Harga</td>
              <td><label for="nama">
            ...
            <tr>
              <td>Keterangan</td>
              <td><textarea name="isi" id="txtarea" cols="65" rows="10"><?php echo $r_edit[isi]; ?></textarea></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
    ...
    <h2>TAMBAH PRODUK</h2>
      <form action="" method="post" enctype="multipart/form-data">
          <table border="0">
            ...
            <tr>
              <td>Keterangan</td>
              <td><textarea name="isi" id="txtarea" cols="65" rows="10"></textarea></td>
            </tr>
            <tr>
              <td>Gambar</td>
...
<table border="1" align="center">
  ...
  <tr>
    <td><?php echo $r[1];?></td>
    <td align="center"><img src="../produk/small/<?php echo $r[3];?> "/></td>
